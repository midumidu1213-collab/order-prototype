# Danh mục Tài liệu User Stories - Tính năng Yêu cầu Hủy SO

Thư mục này chứa toàn bộ các User Stories đặc tả chi tiết cho tính năng **Yêu cầu hủy SO (Cancel Sales Order Requests)** thuộc hệ thống Sevago Jewelry.
...
## 🔗 Liên kết liên quan
*   **Source Code Prototype:** [order-prototype/src/app/cancel-requests/](file:///D:/BA/H%E1%BB%8Dc%20AI/order-prototype/src/app/cancel-requests)
*   **Trải nghiệm Localhost:** [http://localhost:3000/cancel-requests](http://localhost:3000/cancel-requests)
