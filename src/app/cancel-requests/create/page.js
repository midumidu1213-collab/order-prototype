...
export default function CreateCancelRequest() {
  ...
  // Tính tổng SL hủy và Tổng giá trị hủy
  const totalCancelQty = items.reduce((sum, item) => sum + (Number(item.qty) || 0), 0);
  const totalCancelAmount = items.reduce(
        ...
        <div className="p-6 grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div>
            ...
            <select
              ...
              className="mt-1 block w-full border border-gray-300 bg-white rounded-md shadow-sm py-2 px-3 focus:ring-[#005a46] focus:border-[#005a46] sm:text-sm font-bold text-[#005a46]"
            >
              <option value="SO2608001">SO2608001</option>
              <option value="SO2608002">SO2608002</option>
              <option value="SO2608003">SO2608003</option>
              <option value="SO2608004">SO2608004</option>
              <option value="SO2608005">SO2608005</option>
            </select>
          </div>
          ...
          <div>
            ...
            <input
              ...
              className="mt-1 block w-full bg-gray-50 border border-gray-300 rounded-md shadow-sm py-2 px-3 text-sm font-semibold text-gray-800 focus:outline-none cursor-not-allowed truncate"
      ...
      <div className="bg-white shadow rounded-lg border border-gray-200 overflow-hidden">
        ...
        <div className="overflow-x-auto">
          <table className="min-w-full divide-y divide-gray-200">
                    ...
                    <td className="px-3 py-3 text-center">
                      {item.image ? (
                        <img
                          src={item.image}
                          alt={item.itemCode}
                          className="h-10 w-10 object-cover rounded-md border border-gray-200 mx-auto shadow-xs"
                        />
                      ) : (
                        <div className="h-10 w-10 bg-gray-100 rounded-md border border-gray-200 flex items-center justify-center mx-auto text-gray-400">
            ...
            <tfoot className="bg-gray-50 font-semibold text-gray-900 border-t border-gray-200 text-xs">
              <tr>
