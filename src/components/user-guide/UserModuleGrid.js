...
export default function UserModuleGrid({ onSelectModule }) {
  // Lấy 10 module tiêu biểu theo đúng bản vẽ thiết kế (2 hàng x 5 cột)
        ...
        {displayModules.map((mod) => (
          ...
          >
            <div className="flex items-center space-x-3.5 min-w-0">
              {/* Icon avatar vuông tròn xanh dương nổi bật chuẩn UI */}
